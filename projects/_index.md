...
| [`orch`](https://github.com/adiled/orch) / [`orchd`](https://github.com/adiled/orchd) | T3 | Rust | 0 | 2026-03-07 | Orchfile parser and spec library plus its execution engine. Containerfile-shaped DSL with systemd-drop-in overlay semantics. | [→](./orch.md) |
