...
| [`ccft`](https://github.com/adiled/ccft) | T2 | Rust | 0 | 2026-05-08 | Working CLI, MITM proxy with token ledger. Niche T2. Claude Code power-user audience. | [→](./ccft.md) |
| [`bhai-lang`](https://github.com/adiled/bhai-lang) | T3 | Python | 0 | 2026-04-15 | Kinship-typed lineage language. Naming collision with the popular Hindi-keyword `bhai-lang`. Block on resolving before launch. | [→](./bhai-lang.md) |
