...
- Linked from `clwnd`'s README as "see what running this looks like."
- Linked from `clwnd`'s `adils.me` thesis post as a live example.
- *Not* listed on awesome-lists.
- *Not* part of any launch beat for any other project.
- *Not* promoted on social.
...
If `clwnd-playground` ever stops being a `clwnd` demonstration and starts becoming a serious project unto itself (e.g. the arena battle system grows into a real teaching tool), it graduates to a higher tier and gets its own dossier. Until then, T4.
